...
mkdir -p src test docs/project/plans

# Create a simple implementation plan
cat > docs/project/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/project/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/project/plans/implementation-plan.md using the subagent-driven-development skill.
