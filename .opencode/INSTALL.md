# Installing Sjujperpowers for OpenCode
...
1. Check logs: `opencode run --print-logs "hello" 2>&1 | grep -i sjujperpowers`
...
- Full documentation: https://github.com/codyw912/sjujperpowers/blob/main/docs/README.opencode.md
